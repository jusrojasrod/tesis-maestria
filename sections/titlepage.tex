...
\begin{titlepage}
    ...
    {\large Advisor} \par
    {\advisorName} \par
    \vspace{0.9cm} % Espacio después del asesor

    % --- Comité / Jurado (estilo Del Valle, con puntos guía) ---
    % Edita los nombres y afiliaciones de tu jurado.
    {\large \textit{Committee}} \par
    \vspace{0.25cm}
    \begin{minipage}{0.72\textwidth}
        \normalsize
        Nombre del jurado 1 \dotfill Afiliación 1\par
        Nombre del jurado 2 \dotfill Afiliación 2\par
        Nombre del jurado 3 \dotfill Afiliación 3\par
    \end{minipage} \par
    \vspace{0.7cm}
